<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Pengaturan Statis') }}
            </h2>
            <a href="{{ route('admin.setting.statis.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
    ...
    <script>
        ...
        function updateTableDisplay() {
            ...
            filteredData = filteredData.filter(setting => setting.type === 'statis');
