<!-- Clouds Divider -->
<div class="shapedividers_com-8265 relative h-32 w-full">
    <style>
        .shapedividers_com-8265 {
            overflow: hidden;
            position: relative;
        }
        .shapedividers_com-8265::before {
            content: '';
...
<footer class="relative text-white w-full overflow-hidden">
    <!-- Background Color Layer -->
    <div class="absolute inset-0 w-screen h-full min-w-[100vw]" style="background-color: #4F46E5;"></div>
    
    <!-- Background Image Layer -->
    <div class="absolute inset-0 w-screen h-full min-w-[100vw]">
        <img src="{{ asset('images/ft-img.png') }}" alt="Footer Background" class="w-full h-full object-cover min-w-[100vw] object-center">
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        <img src="{{ asset('images/logo_kla.png') }}" alt="KLA KATINGAN" class="h-24 w-auto">
                        <div class="ml-4">
                            <h2 class="text-4xl font-bold text-white">Lindungi Anak</h2>
                            <h3 class="text-2xl text-white">Dimanapun Mereka Berada</h3>
                        </div>
                    </div>
                    <div class="space-y-4 text-lg text-white">
                        <p>Pemerintah Daerah Kabupaten Katingan</p>
                        <p>Website Resmi Kabupaten Layak Anak</p>
                        <div class="w-24 h-1 bg-white my-8"></div>
                        <p>Jalan Ahmad Yani, Kompleks Perkantoran Pemkab Katingan</p>
                        <p>Telp/Fax : (0536) 4043577</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                    <div class="lg:col-span-3 h-[325px] rounded-lg overflow-hidden shadow-lg">
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3986.4793826070454!2d113.91141661475503!3d-2.2012943984004847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de052c3c1e7c3ed%3A0x7c5e14f03d2a3d4c!2sKantor%20Bupati%20Katingan!5e0!3m2!1sid!2sid!4v1647850716751!5m2!1sid!2sid"
                            width="100%" 
                            height="100%" 
                            style="border:0;" 
                            allowfullscreen="" 
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <div class="p-4 rounded-lg bg-white/5 backdrop-blur-sm">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-sm text-gray-200">Total Pengunjung</p>
                                    <p class="text-2xl font-bold text-white">{{ \App\Models\Statistic::count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 rounded-lg bg-white/5 backdrop-blur-sm">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-sm text-gray-200">Pengunjung Hari Ini</p>
                                    <p class="text-2xl font-bold text-white">{{ \App\Models\Statistic::whereDate('created_at', today())->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 rounded-lg bg-white/5 backdrop-blur-sm">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-sm text-gray-200">Pengunjung Online</p>
                                    <p class="text-2xl font-bold text-white">{{ \App\Models\Statistic::getOnlineVisitors() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
