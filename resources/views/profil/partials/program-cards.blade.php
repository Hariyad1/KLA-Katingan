@if($programKerjas->isEmpty())
    <div class="text-center py-10 bg-gray-50 rounded-lg">
        ...
        <h3 class="text-lg font-medium text-gray-600">Belum ada program kerja untuk kriteria yang dipilih</h3>
        <p class="text-gray-500 mt-2">Silakan pilih filter lain atau hubungi administrator</p>
    </div>
@else
