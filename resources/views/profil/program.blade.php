                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="bg-gray-50 rounded-lg p-8">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <h2 class="text-2xl font-bold text-gray-800">Program Jangka Pendek</h2>
                                </div>
                                <ul class="space-y-4">
                                    <li class="flex items-start gap-3">
                                        ...
                                        <span class="text-gray-700">Program 1</span>
                                    </li>
                                    <li class="flex items-start gap-3">
                                        <svg class="w-5 h-5 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                        </svg>
                                        <span class="text-gray-700">Program 2</span>
                                    </li>
                                    <li class="flex items-start gap-3">
                                        <svg class="w-5 h-5 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                        </svg>
                                        <span class="text-gray-700">Program 3</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-8">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <h2 class="text-2xl font-bold text-gray-800">Program Jangka Panjang</h2>
                                </div>
                                <ul class="space-y-4">
                                    <li class="flex items-start gap-3">
